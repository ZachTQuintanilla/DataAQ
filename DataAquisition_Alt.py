...
class DataAQ():
    ...
    def Sartorius_init(self,COM):
        ...
        ser = serial.Serial(port = '/dev/serial/by-id/usb-Sartorius_Sartorius_Composite_device_0000000000-if00', baudrate = 9600, parity = serial.PARITY_ODD, stopbits = serial.STOPBITS_ONE, bytesize = serial.EIGHTBITS, timeout = None)
        self.ser = ser
